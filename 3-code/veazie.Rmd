...
veazie_c_cont <- predict(c.mod, veazie_c_pred, interval = "prediction")[1] * 0.01 # covert % to proportion
...
res_burial_summary <- data.frame(period = c("before"), flux = c("reservoir burial"), variation = NA, flux_unit = c("CO2-eq", "C"), annual = "yes", area = "reservoir", mean = c(-(veazie_burial[round(vec_length * 0.5)] * (44.01/12.01)), -veazie_burial[round(vec_length * 0.5)]), ci_lwr = c(-(veazie_burial[round(vec_length * 0.975)] * (44.01/12.01)), -veazie_burial[round(vec_length * 0.975)]), ci_upr = c(-(veazie_burial[round(vec_length * 0.025)] * (44.01/12.01)), -veazie_burial[round(vec_length * 0.025)]))
...
write.csv(summary_df, "../2-output-data/veazie_summary_20240725.csv", row.names = FALSE)
```

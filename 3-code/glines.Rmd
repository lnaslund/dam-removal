...
res_emissions_summary <- data.frame(period = c("before"), 
                                    ...
                                    variation = c("with degassing", "with degassing", "without degassing", "without degassing"), 
                                    flux_unit = rep(c("CO2-eq", "C"),2), 
                                    annual = "yes", 
                                    area = "reservoir", 
                                    mean = c(res_degas_eq, res_degas_g, res_eq, res_g), 
                                    ci_lwr = c(res_degas_eq - res_degas_eq_interval, res_degas_g - res_degas_g_interval, res_eq - res_eq_interval, res_g - res_g_interval), 
                                    ci_upr = c(res_degas_eq + res_degas_eq_interval, res_degas_g + res_degas_g_interval, res_eq + res_eq_interval, res_g + res_g_interval))
```
...
res_burial_summary <- data.frame(period = c("before"), 
                                 ...
                                 annual = "yes", 
                                 area = "reservoir", 
                                 mean = c(-burial_vec[5000]*(44.01/12.01), -burial_vec[5000]), 
                                 ci_lwr = c(-burial_vec[9750]*(44.01/12.01), -burial_vec[9750]), 
                                 ci_upr = c(-burial_vec[250]*(44.01/12.01), -burial_vec[250]))
```
...
res_exp_sed_co2 <- df %>%
  mutate(total_co2_eq = total, 
         total_c = total * (12.01/44.01)) %>%
  group_by(y) %>%
...
res_sed_co2_summary <- data.frame(period = "burp", 
                                  flux = "exposed sediment CO2", 
                                  variation = rep(c(res_exp_sed_co2$y %>% as.character()), 2), 
...
res_sed_ch4_summary <- data.frame(period = c("burp"), 
                                  ...
                                  flux_unit = rep(c(rep("CO2-eq", 5), rep("C", 5)), 2), 
                                  annual = "no", 
                                  area = "exposed sediment area", 
...
res_ch4_eb_eq_2.5 <- res_ch4_eb_eq - (res_degas_eq_interval * (res_ch4_eb_eq/res_degas_eq))
res_ch4_eb_eq_97.5 <- res_ch4_eb_eq + (res_degas_eq_interval * (res_ch4_eb_eq/res_degas_eq))
...
res_erode_summary_alt <- data.frame(period = c("burp"), 
                                    flux = c("eroded sediment emissions"), 
                                    variation = NA, 
                                    flux_unit = c("CO2-eq", "C"), 
                                    annual = "no", 
                                    area = "reservoir", 
                                    mean = c(eroded_vec_alt[5000] * (44.01/12.01), eroded_vec_alt[5000]), 
                                    ci_lwr = c(eroded_vec_alt[250] * (44.01/12.01), eroded_vec_alt[250]), 
                                    ci_upr = c(eroded_vec_alt[9750] * (44.01/12.01), eroded_vec_alt[9750]))
...
riv_ch4_summary <- data.frame(period = c("build"), 
                              ...
                              variation = NA, flux_unit = c("CO2-eq", "C"), annual = "yes", area = "river", mean = c(riv_ch4_flux_gCO2eq, riv_ch4_flux_gC), ci_lwr = c(riv_ch4_flux_2.5_gCO2eq, riv_ch4_flux_2.5_gC), ci_upr = c(riv_ch4_flux_97.5_gCO2eq, riv_ch4_flux_97.5_gC))
```
...
write.csv(summary_df, "../2-output-data/glines_summary_20241213.csv", row.names = FALSE)
```
